...
def read_data_from_spreadsheet(
    ...
    if '.xlsx' in filename or '.xls' in filename:
        ...
        if len(spreadsheet_file.sheet_names) >= 1:
...
def thorntw_mater_proc(source_path, LAT, SM, SRT, beta, mean_calc, file_out, img_out, plot_show = False):
    ...
    try:
        ...
        df.to_excel(file_out, sheet_name='results', index=False)
